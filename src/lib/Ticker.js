...
export default class Ticker {
    ...
    static stopAll() {
        [...runningTickers].forEach(t => t.stop());
    }
    ...
    constructor(callback = null, options = {}) {
        ...
        this.usePerformanceNow(Boolean(options.usePerformanceNow));
        this.useTimeout(Boolean(options.useTimeout));
    ...
    stop() {
        ...
        const idx = runningTickers.indexOf(this);
        if (idx >= 0) {
